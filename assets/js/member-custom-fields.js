...
(()=>{
  ...
  function ensureSettingsPanel(){
    ...
    panel=document.createElement('section');panel.id='memberMetadataSettingsPanel';panel.className='settings-simple-section member-metadata-settings';
    panel.innerHTML='<div class="settings-simple-heading member-metadata-header"><div class="member-metadata-title"><p class="eyebrow">Member metadata</p><h3>Custom fields and tags</h3><p class="muted">Add structured profile details and reusable labels for search and filtering.</p></div></div><p class="settings-metadata-search-note">Search with <code>source:RE</code>, <code>tag:frequent</code>, or plain words.</p><div class="member-metadata-settings-grid"><section class="member-metadata-section"><div class="member-metadata-section-heading"><div><strong>Custom fields</strong><small id="customFieldCount">0 fields</small></div><button id="newCustomFieldButton" class="text-button compact-metadata-button" type="button">+ New field</button></div><div id="customFieldDefinitionList" class="member-metadata-list"></div></section><section class="member-metadata-section"><div class="member-metadata-section-heading"><div><strong>Tags</strong><small id="memberTagCount">0 tags</small></div><button id="newMemberTagButton" class="text-button compact-metadata-button" type="button">+ New tag</button></div><div id="memberTagDefinitionList" class="member-metadata-list member-tag-definition-grid"></div></section></div>';
    mount.append(panel);
