...
(function(){
  ...
  window.nihilityApi={configured,getSession,saveSession,sendMagicLink,readSessionFromUrl,refresh,user,rest,rpc,upload,deleteMedia,getPkToken,savePkToken,clearPkToken,pk};
})();